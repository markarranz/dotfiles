...
printf "\033]99;i=%s:d=0:a=focus:p=title:o=unfocused;%s\033\\" "$notify_id" "$title" >"/dev/$tty_dev"
printf "\033]99;i=%s:d=1:a=focus:p=body;%s\033\\" "$notify_id" "$msg" >"/dev/$tty_dev"
