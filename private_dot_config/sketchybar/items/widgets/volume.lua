        ...
        sbar.exec("SwitchAudioSource -a -t output", function(devices_str)
          ...
          for device in devices_str:gmatch("[^\n]+") do
            ...
            sbar.add("item", "volume.device." .. counter, {
              ...
              click_script = 'SwitchAudioSource -s "' .. device .. '" && sketchybar --set /volume.device\\..*/ label.color=' .. colors.grey .. ' --set $NAME label.color=' .. colors.white .. ' --set ' .. volume_icon.name .. ' popup.drawing=off',
            })
          end
        end)
      end)
